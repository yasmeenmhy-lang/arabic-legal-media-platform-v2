...
function professionalismExplanation(score: number) {
  ...
  if (score >= 60) return { explanation: "الأسلوب بحاجة لتحسين ليستوفي المعايير المهنية المعتمدة.", action: "ارتقِ بالأسلوب إلى المعايير المهنية المعتمدة بما يناسب نوع المحتوى وجمهوره وقناته — دون تغيير طبيعة النوع." };
  return { explanation: "الأسلوب غير مستوفٍ للمعايير المهنية المعتمدة — يحتاج إعادة كتابة كاملة.", action: "اكتب النص من جديد بلغة فصحى مهنية وفق قالب نوع المحتوى ومقاييسه وبما يناسب جمهوره." };
}
