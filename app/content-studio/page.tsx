...
const purposes = [
  ...
  // (بقرار المالكة): خياران إضافيان — «أخرى» لهدف خارج القائمة، و«لا يوجد»
  // حين لا هدف محدد؛ كلاهما يمر للكاتب والمحاكم كسياق عام محايد لا كادعاء هدف
  "أخرى",
  "لا يوجد هدف محدد",
];
