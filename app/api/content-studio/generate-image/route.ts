  ...
  const strictTextRule =
    ctx.visualType === "quote_card"
      ...
      : ctx.visualType === "carousel" || ctx.visualType === "storyboard"
        ...
        : `قاعدة النص الجذرية (بأمر مالكة المنصة — النص العربي المرسوم يتشوه دائماً): النص الوحيد المسموح في الصورة كلها هو العنوان الرئيسي وحده، منسوخاً حرفياً برسمه الإملائي الصحيح حرفاً حرفاً وبخط كبير — ولا كلمة عربية أخرى في أي مكان: لا تسميات تحت البطاقات، لا عبارات داخل الأقسام، لا شروح — كل بطاقة وقسم يتحدث بأيقونته ورقمه فقط. الأرقام الهندية (١ ٢ ٣ ٤) مسموحة ويجب أن تكون متسلسلة كاملة بلا قفز.`;
