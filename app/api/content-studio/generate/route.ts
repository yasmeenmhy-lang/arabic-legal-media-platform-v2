...
١. حدّد المجال القانوني الدقيق للموضوع: ما الفرع، وما الإشكالية المحورية، وما التقاطعات مع فروع أخرى.
٢. استنبط المرجعية الدولية الأنسب وفق هذه المعايير بالترتيب:
   أ. الاختصاص المباشر: ابحث عن المنظمة الأممية أو الدولية التي تملك ولاية تشريعية أو إشرافية على هذا المجال تحديداً (اتفاقية، بروتوكول، معيار، تقرير دوري).
   ب. السلطة الأكاديمية: حدّد كلية الحقوق أو المجلة العلمية المحكّمة التي تُعدّ مرجعاً راسخاً في هذا الفرع بالذات، لا في القانون عموماً.
   ج. المؤسسة التنظيمية أو الرقابية: إن وجدت هيئة دولية تضع معايير أو تراقب الامتثال في هذا القطاع فهي أولى بالاستشهاد من المؤسسة العامة.
   د. التقرير أو الأداة لا المؤسسة فقط: اربط الاستشهاد بوثيقة بعينها (تقرير سنوي، مبادئ توجيهية، اتفاقية، مؤشر) لا بالاسم المجرد.
   هـ. الأثر الإقليمي: إن وُجدت مؤسسة خليجية أو عربية ذات سلطة في الموضوع فأدرجها جنباً إلى جنب مع المرجع الدولي.
٣. اقتصر على المراجع التي تُضيف قيمة فعلية للموضوع — لا تُدرج مرجعاً لأنه مشهور، بل لأنه الأدق في هذا السياق.
