...
- إطار النوع أعلاه هو الحاكم عند أي تعارض: النوع الموجز يبقى موجزاً بقالبه مهما اتسعت مساحة القناة
${briefType
...
- التزم بأعراف قناة ${channel} في البنية والنبرة وكثافة المعلومة (منشور اجتماعي موجز ومباشر، مقال موقع متدرج ومعمق، نص فيديو حواري بإيقاع مسموع)
