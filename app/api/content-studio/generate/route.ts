...
- ممنوع نسبة المحتوى إلى أي جهة رسمية أو كتابة عبارات مثل "مصدر: وزارة العدل" أو "مصدر: هيئة المحامين" وما شابهها — عند الاستشهاد اذكر النظام والمادة فقط (مثل: نظام العمل — المادة 74)
