...
٢. استنبط المرجعية الدولية الأنسب وفق هذه المعايير:
   أ. الاختصاص المباشر: ابحث عن المنظمة أو الهيئة الدولية التي تملك الولاية الأعلى سلطةً على هذا المجال تحديداً. اختر الأدق اختصاصاً بصرف النظر عن شهرتها العامة.
   ب. المعيار أو الوثيقة لا الاسم فقط: اربط الاستشهاد بوثيقة بعينها (اتفاقية، تقرير، مبادئ توجيهية، معيار، مؤشر) لا بمجرد ذكر اسم المنظمة.
