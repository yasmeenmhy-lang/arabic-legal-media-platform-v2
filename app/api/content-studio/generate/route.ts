...
٢. استنبط المرجعية الأنسب وفق هذه المعايير بالترتيب:
   أ. الاختصاص المباشر: ابحث عن الجهة — أممية أو دولية أو إقليمية أو وطنية — التي تملك الولاية الأعلى سلطةً على هذا المجال تحديداً (اتفاقية، معيار، تقرير دوري). اختر الأدق اختصاصاً بصرف النظر عن شهرتها العامة.
   ب. السلطة الأكاديمية: حدّد كلية الحقوق أو المجلة العلمية المحكّمة الأرسخ في هذا الفرع بالذات، لا في القانون عموماً.
   ج. المؤسسة التنظيمية أو الرقابية: إن وجدت هيئة تضع معايير أو تراقب الامتثال في هذا القطاع فهي أولى من المؤسسة العامة.
   د. الوثيقة لا المؤسسة فقط: اربط الاستشهاد بوثيقة بعينها (تقرير، مبادئ توجيهية، اتفاقية، مؤشر) لا بالاسم المجرد.
