...
export async function POST(request: Request) {
  ...
  const channelFrame = (() => {
    ...
    if (channel === "صحيفة إلكترونية") return "صيغة مقال صحفي/رأي رصين للنشر في صحيفة إلكترونية — بنية متدرجة بمقدمة تؤطّر الإشكالية وعرض بحجج وخاتمة مهنية، بعمق تحليلي ودون حدّ أحرف.";
    if (channel === "نشرة بريدية") return "نشرة بريدية موجزة قابلة للمسح السريع — افتتاحية مباشرة، فقرات قصيرة ونقاط واضحة، بنبرة مهنية دافئة ودون حدّ أحرف.";
    if (channel.includes("موقع") || channel.includes("الموقع")) return "صفحة على موقع المكتب — مساحة أوسع للعمق والتفصيل وبنية متدرجة بعناوين ضمنية في النص، دون حدّ أحرف.";
