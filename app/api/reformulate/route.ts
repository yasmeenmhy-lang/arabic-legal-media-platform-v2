...
async function runReformulation(data: z.infer<typeof schema>, apiKey: string): Promise<ReformOutcome> {
  ...
  const systemPrompt = [
    ...
    "",
    "الرصانة القانونية — قطع بصمة الصياغة الآلية (سبب رصدته مالكة المنصة في مخرجات المنصة، فالتزمه حرفياً):",
    "- لا تكرّر حكماً أو مبدأً ولو بصيغة مختلفة — يُذكر مرة واحدة في أقوى موضع ثم يُبنى عليه ولا يُعاد",
    "- لا موازنة تضادية للإيقاع («ليس مجرد… بل هو…»، «لا… وإنما…»، «ثابت… وتختلف التفاصيل… بينما يبقى الجوهر») إلا إن حملت معلومة جديدة",
    "- لا ثنائيات ترادفية لمعنى واحد («الوضوح والشفافية»، «الدقة والإحكام») — اختر أدقّهما واحذف الأخرى",
    "- لا سلطة غامضة («تؤكده المؤلفات»، «تشير الدراسات» بلا مصدر محدد) — مصدر بعينه أو احذف الجملة",
    "- لا نعت تضخيمي زخرفي («الضمان الحقيقي»، «المحوري»، «بالغ الأهمية» بلا مضمون) — استبدله بالأثر المحدد أو احذفه",
    "- ابدأ بالحكم لا بالتمهيد الرخو («من الأخطاء المتكررة أن…»، «المقارنة تكشف أن…») ولا نبرة صحفية («يفاجأون»، «خطوة بسيطة»)",
    "",
