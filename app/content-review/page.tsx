      ...
      <section
        ...
        className={
          hasSelectedContent
            ...
            : "w-full max-w-full overflow-x-clip rounded-xl border border-line border-r-2 border-r-palm bg-white px-6 py-10 shadow-sm sm:px-8 sm:py-12"
        }
      >
        ...
        {savedRecords.length > 0 ? (
          <div className="relative" ref={recordSearchRef}>
            <div className={`flex items-center gap-2.5 rounded-lg border bg-white transition ${
              ...
              <input
                type="text"
                placeholder={hasSelectedContent ? "بحث" : "ابحث في المحتوى"}
                value={recordSearch}
