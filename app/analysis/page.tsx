...
export default function ContentReviewPage() {
  ...
  async function runReview(quick = false) {
    ...
    // ★ نُسخ قفل «النص نفسه = الحكم نفسه» بأمر مالكة المنصة: كانت الضغطة الثانية
    // على نصٍّ لم يتغيّر لا تصل المحرك أصلاً فيُعاد عرض الحكم السابق حرفياً.
    // الآن كل ضغطة مراجعة حكمٌ جديد كامل من المحرك، ولو كان النص هو النص.
