...
const MOCK_REVIEW: ReviewResult = {
  ...
  findings: [
    ...
    },
    {
      ...
      suggestedSaferWording: "تجنب ربط المكتب بالمظاهر المادية والتركيز على الخبرة القانونية ونطاق الخدمة.",
  ...
  governedRewrites: [
    {
      id: "rw-001",
      suggestedText: "نحرص في مكتبنا على تقديم خدمات قانونية تجمع بين الخبرة العميقة والالتزام بمعايير المهنة المعتمدة. نسعد بخدمتكم.",
  ...
  confidence: {
    ...
    evidenceQuality: "توجد مخالفات مرصودة لقواعد السلوك المهني أو اللائحة التنفيذية.",
  },
  readinessDecision: {
    level: "غير جاهز",
