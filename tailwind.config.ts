  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        paper:           "#FCFCFD", // Gray 25  — سطح داخلي فاتح
        surface:         "#F9FAFB", // Gray 50  — سطح يعلو خلفية الصفحة
        line:            "#E7ECE8", // حدّ محايد مائل للأخضر — يتّسق مع خلفية الصفحة
        // ★ خلفية الصفحة (بقرار مالكة المنصة — تخفيف حدة الأبيض): محايد دافئ مائل
        // للأخضر يرتبط بهوية palm، والبطاقات تبقى بيضاء فتنفصل عنه بالظل لا بالتباين.
        canvas:          "#F6F8F7",
      ...
      boxShadow: {
        ...
        // ★ ظل البطاقات الكبيرة (بقرار مالكة المنصة): العمق بالظل لا بالتباين
        // اللوني — واسع وخفيف جداً، يرفع البطاقة البيضاء عن خلفية الصفحة بلا ثِقَل.
        // مقصور على البطاقات الكبيرة؛ العناصر الصغيرة تبقى على sm/xs فلا تثقل.
