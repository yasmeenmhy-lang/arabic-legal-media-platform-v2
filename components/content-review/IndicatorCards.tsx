...
export function professionalismExplanation(score: number) {
  if (score >= 80) return { explanation: "الأسلوب رصين ومستوفٍ للمعايير المهنية المعتمدة.", action: "حافظ على هذا المستوى من الرصانة في جميع منشوراتك." };
  ...
  return { explanation: "الأسلوب غير مستوفٍ للمعايير المهنية المعتمدة — يحتاج إعادة كتابة كاملة.", action: "اكتب النص من جديد بلغة فصحى رصينة تخدم هدفاً مهنياً أو تثقيفياً واضحاً." };
}
