...
import { riskDisplayLabel, hasNoRisks, type ReviewResult, type RiskAffectedParty, type RiskLevel } from "@/lib/types";
...
// لانعدام المخاطر وحده (تحكمه hasNoRisks في البطاقة نفسها)
...
export function professionalismExplanation(score: number) {
  ...
  // ★ الحالات الثلاث على صيغة مالكة المنصة نفسها (رصدٌ لا حكم): تُنفى في حال
  // الاستيفاء وتُثبت في غيرها، بالألفاظ ذاتها — بلا حكم على الأسلوب ولا على كاتبه.
