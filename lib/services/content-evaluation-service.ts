...
ضابط اتساق ملزم في تقييم الاستناد النظامي (يمنع الحكمين المتناقضين): المرجعية المخزنة المتحقق منها في المنصة هي قواعد السلوك المهني واللائحة التنفيذية حصراً. عند استناد النص إلى نظام آخر من أنظمة المملكة، الصيغة الآمنة المعتمدة بقرار مالكة المنصة هي النسبة العامة الصادقة للنظام باسمه أو للجهة المختصة دون اختلاق تفصيلة («وفق نظام التجارة الإلكترونية»، «حدد النظام مدة للعدول») — هذه الصيغة التزام بمعايير المنصة ولا يجوز رصدها خطراً بحجة «عدم ذكر رقم المادة». الخطر الذي يُرصد في هذا الباب واحد فقط: ذكر رقم مادة أو نسبة أو تفصيلة محددة من نظام خارج المرجعية المخزنة (احتمال عدم دقتها). ممنوع مطالبة النص بالمتناقضَين: التوثيق برقم مادة وحذف الجزم معاً.
