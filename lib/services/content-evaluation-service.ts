...
دقة المسميات الرسمية ضمن هذا المحور: إذا ذُكرت جهة بمسمّى قديم مُلغى دون تسميتها باسمها الرسمي الحالي (مثل «مؤسسة النقد العربي السعودي» والاسم الحالي «البنك المركزي السعودي (ساما)») فترصد ملاحظة بفئة style تقترح المسمّى الحالي — ذكر الاسم القديم مقبول فقط إيضاحاً تاريخياً بجانب الاسم الحالي.
