...
استثناء الولاية (الخطاب الديني أو العقدي أو الفتوى وحدها): هذا المحتوى خارج ما تغطّيه المنصة، فلا يُقاس أسلوبه بمعيار الكتابة القانونية ولا يُطالَب بلغة قانونية أو تأصيل نظامي — إذ لا معنى لمطالبة نصٍّ لا تغطّيه المنصة بأن يُكتب بلغة المهنة. في هذه الحالة وحدها اجعل score = 85 و passed = true، واجعل explanation هذه الجملة حرفياً دون زيادة: «هذا المحتوى خارج نطاق ما تغطّيه المنصة.» واترك fix فارغاً.
ولا يمسّ هذا الاستثناء محور المخاطر ولا محور اللغة: يُقيَّمان كاملَين بلا تخفيف، وكل مخالفة لقواعد السلوك المهني أو مساس بكرامة المهنة يُرصد في هذا النص كما يُرصد في أي نص آخر.
