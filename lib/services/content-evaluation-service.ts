...
## المبدأ الأساسي — اقرأه أولاً قبل أي تقييم
المحامي لا ينشر إلا ما يخدم المهنة القانونية أو يُعلّم الجمهور أو يوضح حقوقهم.
أي محتوى خارج هذا الإطار هو مخالفة تلقائية بغض النظر عن أسلوبه أو كلماته.

المحتوى المخالف تلقائياً يشمل على سبيل المثال لا الحصر:
- إظهار الثروة أو المقتنيات المادية (سيارات، عقارات، رفاهية)
- الإعلان عن الإنجازات الشخصية بأسلوب ترويجي لا علاقة له بالمهنة
- المحتوى الترفيهي أو الاجتماعي العام
- أي محتوى هدفه إبراز المكانة المادية أو الاجتماعية للمحامي
...
قيّم سلامة النص لغوياً ونحوياً ووضوحه. اللغة العامية في منشورات المحامي مخالفة مهنية بحد ذاتها.
