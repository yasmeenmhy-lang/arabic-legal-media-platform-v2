...
قيّم سلامة النص لغوياً ونحوياً ووضوحه. في منشورات وسائل التواصل الاجتماعي، اللغة العامية مقبولة وليست خطأً لغوياً بحد ذاتها. ركّز هذا المحور على الأخطاء الإملائية الفعلية، والتعبيرات الركيكة أو المبهمة التي تضعف وضوح المعنى. الابتذال أو الاستخفاف أو الأسلوب غير اللائق بمحامٍ مرخص: يُرصد تحت محور الكتابة المهنية (professionalWriting)، لا هنا. لا تخفض الدرجة بسبب استخدام العامية وحده.
