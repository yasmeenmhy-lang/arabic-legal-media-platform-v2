...
حدد هل يوجد خطر على أي من هذه الجهات:
...
حكم بذكاء هل أسلوب الكتابة يعكس رصانة وجدية تليق بمحامٍ مرخص.
...
قيّم سلامة النص لغوياً ونحوياً ووضوحه. لا تعتمد على أنماط محددة — حكم بذكاء كامل.
