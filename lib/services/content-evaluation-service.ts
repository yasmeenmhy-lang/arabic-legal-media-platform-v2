...
6. التعريف بالخبرات والمشاركات المهنية (مؤتمرات، عضويات، أوراق عمل) بأسلوب رصين دون مبالغة
...
ثم حدد الجهات المتضررة من سياق النص نفسه — اقرأ المحتوى واستنتج من سيتأثر به فعلياً:
...
اكتب explanation بوصف الأثر على الجهات المتضررة فقط: من تضرر وكيف وما العاقبة المحتملة — بلغة مباشرة، ودون الاستشهاد بأهداف النشر أو محاكمة النص ضدها (تقييم الأهداف محله محور الكتابة المهنية).
