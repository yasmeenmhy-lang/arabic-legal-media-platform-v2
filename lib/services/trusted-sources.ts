...
const INTERNATIONAL_DOMAINS: string[] = [
  ...
  // ★ نطاقات رسمية دولية كانت ناقصة فتعذّر البحث في مواضيعها (بقرار مالكة
  // المنصة بعد رصدها: موضوع المحكمة الجنائية الدولية عاد بلا مصادر لأن موقعها
  // الرسمي نفسه لم يكن مسموحاً للباحث)
  "icc-cpi.int",          // المحكمة الجنائية الدولية
  "ohchr.org",            // المفوضية السامية لحقوق الإنسان
  "unodc.org",            // مكتب الأمم المتحدة المعني بالمخدرات والجريمة
  "coe.int",              // مجلس أوروبا
  "echr.coe.int",         // المحكمة الأوروبية لحقوق الإنسان
  "icrc.org",             // اللجنة الدولية للصليب الأحمر
  "pca-cpa.org",          // محكمة التحكيم الدائمة
  "worldjusticeproject.org", // مشروع العدالة العالمي
