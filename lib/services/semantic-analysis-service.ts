...
import { PLATFORM_SUPREME_RULE } from "@/lib/governance";
...
2. امسح النص كاملاً مرة أخيرة بمقاصد القواعد واللائحة — تأكد أنك لم تفوّت شيئاً قبل أن تعتبر القائمة نهائية.
