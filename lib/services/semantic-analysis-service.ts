...
3. تأكد أن كل استشهاد يطابق اسم مرجع ورد حرفياً في فهرس المراجع أدناه، وأن كل دليل منسوخ حرفياً من النص. ومرجعا الحكم في هذه المنصة اثنان لا ثالث لهما، ويُذكران بأسميهما الرسميين حرفاً: «قواعد السلوك المهني للمحامين» و«اللائحة التنفيذية لنظام المحاماة» — ولا يُخترع لهما ولا لأي جزء منهما مسمّى بديل من عندك أبداً.
الأثر في التعليل يُذكر بصيغة الشأن والاحتمال — «من شأنه»، «قد يؤدي إلى» — لا بصيغة الوقوع الجازم، لأن الأثر متوقّع لا واقع. ولا يُبَتّ في واقعة خارج النص لا سبيل إلى العلم بها من النص نفسه. وألفاظ التعليل جميعها من المعجم النظامي المعتمد في المملكة حصراً.
