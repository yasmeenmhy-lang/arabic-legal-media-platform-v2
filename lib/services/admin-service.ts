...
const userActivityLog: UserActivityLogEntry[] = [
  ...
  { user: "نورة القحطاني", role: "مشرف محتوى", action: "اعتماد تحديث مرجعي من وزارة العدل", at: "2026-06-14T14:05:00.000Z" },
  { user: "سارة العتيبي", role: "إدارة المنصة", action: "تحديث صلاحيات مستخدم", at: "2026-06-14T11:40:00.000Z" },
  { user: "أحمد الحربي", role: "محام", action: "تجهيز حزمة تصدير لمنشور توعوي", at: "2026-06-13T16:30:00.000Z" },
  { user: "نورة القحطاني", role: "مشرف محتوى", action: "مراجعة مسودة محفوظة", at: "2026-06-13T10:15:00.000Z" },
