...
export const alerts = [
  { title: "تحديث مرجعي بانتظار المراجعة", body: "رصدت المنصة تغيراً محتملاً في مصدر من مصادر وزارة العدل ويحتاج متابعة المشرف.", severity: "HIGH" },
  { title: "تصدير متوقف", body: "يوجد محتوى عالي المخاطر يتطلب معالجة الملاحظات قبل التصدير.", severity: "HIGH" },
  { title: "مراجعة لغة معلقة", body: "بعض المحتوى يحتاج تحسين الصياغة قبل استكمال ملاحظات الامتثال والمخاطر.", severity: "MEDIUM" }
] as const;
