...
// النص المُدخل خارج نطاق الأداة أو بلا مادة نظامية/مهنية قابلة لإعادة الصياغة
// (خارج المجال القانوني، أو عبارة تفضيل/أفضلية عامة).
export const NO_SUBSTANCE_MESSAGE =
  "الصياغة المحسّنة مخصّصة للمحتوى الإعلامي والإعلاني المهني للمحامين. النص الحالي لا يتضمّن مسألة نظامية أو مادة قانونية قابلة لإعادة الصياغة ضمن هذا النطاق. أدخل محتوى مهنياً قانونياً (مسألة نظامية أو توعية قانونية) ثم أعد المحاولة.";
