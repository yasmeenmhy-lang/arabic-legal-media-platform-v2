...
export const navItems: Array<{ title: string; href: string; icon: LucideIcon; group: string; soon?: boolean }> = [
  ...
  // «مركز التخطيط» أسفل القائمة (فوق دليل الاستخدام) موسوماً «قريبًا» ومعطّلاً بقرار المالكة — يُفعَّل لاحقاً
  { title: "مركز التخطيط الإعلامي والإعلاني", href: "/calendar-v2", icon: CalendarDays, group: "الرئيسية", soon: true }
];
